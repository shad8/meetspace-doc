\section{Testy}
  ...
  \subsection{Pokrycie kodu testami}
    ...
    Poniżej załączyliśmy diagram obrazujący pokrycie kodu testami w okresie od 10 paździenika do 17 grudnia. Zanotowany duży skok, ilości lini kodu w stosunku do testów, był spowodowany złym umieszczeniem biblioteki JavaScript w projekcie, która nie powinna być wliczana w metrykę.
    \begin{figure}[h]
      \centering
