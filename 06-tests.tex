\section{Testy}
  ...
  \subsection{Testy jednostkowe}
    Testy jednostkowe weryfikują działanie pojedynczych elementów(jednostek) programu, poszczególnych metod czy relacji między obiektami. Test wykonuje dany fragment kodu i porównuje otrzymane wyniki z oczekiwanymi. Na przykładzie pokażemy, że możemy oczekiwać wyników pozytywnych jak i negatywnych(coś się nie udało).
