\section{Wykorzystane technologie}
  ...
  \subsection{Narzędzia do testowania}
    ...
    \begin{itemize}
      \item \emph{Cucumber} \\ Wykorzystywany jest do pisania testów funkcjonalnych(\emph{feature'owych})\footnote{Szerzej o testach w rozdziale \ref{testy}.}. Tworzony jest krótki scenariusz, w którym krok po kroku sprawdza się czy aplikacja zachowuje się w sposób jaki oczekuje klient.
