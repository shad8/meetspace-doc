...
\subsection{API aplikacji Meetspace}
  ...
  Aplikacja zwraca dane w postaci formatu JON\footnote{JSON (JavaScript Objector Notatnik), ustandaryzowany format tekstowy, służący głównie do wymiany danych\cite{json}}, który został wybrany ze względu na popularność, czytelność i łatwość obsługi.\\
