...
\clearpage
Autoryzacja użytkownika, czyli procesy związane z rejestracja i logowaniem, odbywają się z urzyciem gemu \emph{Device}. Aby zaimplementować opcję logowanie za pośrednictwem portali społecznościowyc należ w specjalnym pliku konfiguracyjnym: config/initializers/devise.rb, podać dane autoryzacyjne: API ID i API SECRET.\\
